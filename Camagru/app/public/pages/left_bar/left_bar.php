  ...
  <nav class="left-bar-nav">
    <ul>
      ...
      if ($isLoggedIn) { ?>
        ...
        <li><a href="/pages/upload/upload.php?type=photo" <?php echo (basename($_SERVER['SCRIPT_NAME']) == 'upload.php') ? 'class="active"' : ''; ?>><span class="icon">📷</span>Upload pictures</a></li>
        <li><a href="/pages/upload/upload.php?type=master" <?php echo (basename($_SERVER['SCRIPT_NAME']) == 'upload.php') ? 'class="active"' : ''; ?>><span class="icon">🪟</span>Upload masters</a></li>
